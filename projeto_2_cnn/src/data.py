...
def montar_transform(media_rgb: tuple, desvio_rgb: tuple, tamanho: int = TAMANHO_RESIZE) -> transforms.Compose:
    """
...
def preparar_dataloaders(
    ...
    """
    transform = montar_transform(media_rgb, desvio_rgb, tamanho)
